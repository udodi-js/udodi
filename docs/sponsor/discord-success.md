...
lastUpdated: false
footer: false
pageClass: sponsor-discord-success
---
...
.sponsor-discord-success .sponsor-discord-wrapper {
  max-width: 560px;
  margin: 0 auto;
  padding: 5rem 1.25rem 4rem;
}

.sponsor-discord-success .sponsor-discord-header {
  display: flex;
  justify-content: center;
  margin-bottom: 2.5rem;
}

.sponsor-discord-success .logo-link {
  display: inline-flex;
  align-items: center;
  gap: 0.6rem;
...
.sponsor-discord-success .logo-link:hover {
  color: var(--vp-c-brand-1);
}

.sponsor-discord-success .logo {
  width: 36px;
  height: 36px;
  display: block;
}

.sponsor-discord-success .sponsor-discord-card {
  background: var(--vp-c-bg);
...
.sponsor-discord-success .success-icon {
  width: 48px;
  height: 48px;
...
.sponsor-discord-success .sponsor-discord-card h1 {
  text-align: center;
  font-size: 1.75rem;
  font-weight: 700;
...
.sponsor-discord-success .sponsor-discord-card h2 {
  font-size: 1rem;
  font-weight: 650;
  letter-spacing: -0.01em;
  line-height: 1.4;
...
.sponsor-discord-success .sponsor-discord-card p {
  font-size: 1rem;
  line-height: 1.7;
...
.sponsor-discord-success .sponsor-discord-card .custom-block {
  margin: 2rem 0;
  border-radius: 8px;
...
.sponsor-discord-success .sponsor-discord-card .custom-block p {
  margin: 0;
  text-align: left;
  font-size: 0.95rem;
  color: var(--vp-c-text-2);
...
.sponsor-discord-success .sponsor-discord-action {
  margin-top: 2rem;
  text-align: center;
}

.sponsor-discord-success .back-btn {
  display: inline-flex;
  align-items: center;
  justify-content: center;
  min-width: 180px;
...
.sponsor-discord-success .back-btn:hover {
  background-color: var(--vp-c-brand-2);
  color: #fff !important;
}

.sponsor-discord-success .copyright {
  margin-top: 1.5rem;
  text-align: center;
  font-size: 0.8rem;
...
.dark .sponsor-discord-success .sponsor-discord-card {
