...
lastUpdated: false
footer: false
pageClass: sponsor-discord-connect
---
...
.sponsor-discord-connect .sponsor-discord-wrapper {
  max-width: 560px;
  margin: 0 auto;
  padding: 5rem 1.25rem 4rem;
}

.sponsor-discord-connect .sponsor-discord-header {
  display: flex;
  justify-content: center;
  margin-bottom: 2.5rem;
}

.sponsor-discord-connect .logo-link {
  display: inline-flex;
  align-items: center;
  gap: 0.6rem;
...
.sponsor-discord-connect .logo-link:hover {
  color: var(--vp-c-brand-1);
}

.sponsor-discord-connect .logo {
  width: 36px;
  height: 36px;
  display: block;
}

.sponsor-discord-connect .sponsor-discord-card {
  background: var(--vp-c-bg);
...
.sponsor-discord-connect .sponsor-discord-card h1 {
  text-align: center;
  font-size: 1.75rem;
  font-weight: 700;
...
.sponsor-discord-connect .sponsor-discord-card h2 {
  font-size: 1rem;
  font-weight: 650;
  letter-spacing: -0.01em;
  line-height: 1.4;
...
.sponsor-discord-connect .sponsor-discord-card p {
  text-align: left;
  font-size: 1rem;
  line-height: 1.7;
...
.sponsor-discord-connect .sponsor-discord-card .custom-block {
  margin: 2rem 0;
  border-radius: 8px;
...
.sponsor-discord-connect .sponsor-discord-card .custom-block p {
  margin: 0;
  text-align: left;
  font-size: 0.95rem;
  color: var(--vp-c-text-2);
...
.sponsor-discord-connect .sponsor-discord-action {
  margin-top: 2rem;
  text-align: center;
}

.sponsor-discord-connect .discord-btn {
  display: inline-flex;
  align-items: center;
  justify-content: center;
  gap: 0.55rem;
...
.sponsor-discord-connect .discord-btn:hover {
  background-color: #4752C4;
  color: #fff !important;
}

.sponsor-discord-connect .discord-btn.disabled,
.sponsor-discord-connect .discord-btn[aria-disabled="true"] {
  background-color: #5865F2;
  opacity: 0.45;
  pointer-events: none;
  cursor: not-allowed;
...
.sponsor-discord-connect .discord-icon {
  flex-shrink: 0;
}

.sponsor-discord-connect .sponsor-discord-action .hint {
  margin-top: 1rem;
  text-align: center;
  font-size: 0.875rem;
  color: var(--vp-c-text-2);
...
.sponsor-discord-connect .copyright {
  margin-top: 1.5rem;
  text-align: center;
  font-size: 0.8rem;
...
.dark .sponsor-discord-connect .sponsor-discord-card {
